...
var AppComponent = /** @class */ (function () {
    function AppComponent(router, authService, flashMessagesService) {
        this.router = router;
...
var appRoutes = [
    ...
    { path: '', component: _components_home_home_component__WEBPACK_IMPORTED_MODULE_9__["HomeComponent"], canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_12__["AuthGuard"]] },
    { path: 'profile', component: _components_profile_profile_component__WEBPACK_IMPORTED_MODULE_11__["ProfileComponent"], canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_12__["AuthGuard"]] },
    { path: 'dashboard', component: _components_dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_10__["DashboardComponent"], canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_12__["AuthGuard"]] },
];
...
var ProfileComponent = /** @class */ (function () {
    ...
    ProfileComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.authService.getProfile().subscribe(function (p) {
            _this.user = p.user;
        }, function (err) {
            console.log(err);
            return false;
...
var RegisterComponent = /** @class */ (function () {
    ...
    RegisterComponent.prototype.onRegisterSubmit = function () {
        ...
        this.authService.registerUser(user).subscribe(function (res) {
            if (res.success) {
                _this._flashMessagesService.show('You now are registered and can log in', { cssClass: 'alert-success',
                    timeout: 3000 });
                _this.router.navigate(['/login']);
            }
            else {
...
module.exports = __webpack_require__(/*! D:\Sites\MEAN\Auth\angular-src\src\main.ts */"./src/main.ts");
